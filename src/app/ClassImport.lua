...
ClassImport.BattleMapRoot = ClassImport.BattleRoot.."Map."
...
ClassImport.define = {
	...
	ClassImport.BattleBarrierRoot.."StoneBarrier",
	...
	ClassImport.BattleZoneRoot.."ArtilleryZone",
	ClassImport.BattleZoneRoot.."BonfireZone",
